 ...
 *
 * Server code runs on Node locally (tsx / `vp dev`) and on Cloudflare
...
let cachedCfEnv: Record<string, string | undefined> | null | undefined = undefined;

async function loadCloudflareEnv(): Promise<Record<string, string | undefined> | null> {
